...
import {getOpenUser } from '../../../services/UserService'
const UserOpenProfile = () => {
  let { id } = useParams();
...
getOpenUserFun()
                          ...
                          <div className="d-flex flex-wrap flex-sm-nowrap">
                            ...
                            <div className="me-7 mb-4">
                              <div className="symbol symbol-100px symbol-lg-160px symbol-fixed position-relative">
                                                                ...
                                                                <span className="symbol-label  bg-light-danger text-danger fs-1 fw-bolder">{data && data.profile_photo}</span>
                              ...
                              <div className="d-flex justify-content-between align-items-start flex-wrap mb-2">
                                ...
                                <div className="d-flex flex-column" onClick={() => setMenu(false)}>
                                  ...
                                  <div className="d-flex align-items-center mb-2">
                                    <a href="#" className="text-gray-900 text-hover-primary fs-2 fw-bold me-1">{data && data.name}</a>
 ...
 <div className="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
  ...
  {/*end::Label*/}
                                    ...
                                    {/*begin::follow*/}
                                    <button type="button" class="btn btn-sm btn-primary align-self-center">Follow</button>
                                    {/*end::follow*/}
                                  </div>
                                  {/*end::Stats*/}
                                </div>
...
export default UserOpenProfile