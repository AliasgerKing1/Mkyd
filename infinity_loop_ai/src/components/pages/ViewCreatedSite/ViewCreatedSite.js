                  ...
                  <div className="card card-flush h-md-50 mb-5 mb-xl-10">
                    ...
                    <div className="card-body pt-2 pb-4 d-flex align-items-center">
                      ...
                      <div className="d-flex flex-center me-5 pt-2">
                        <div id="kt_card_widget_4_chart" style={{minWidth: 70, minHeight: 70}} data-kt-size={70} data-kt-line={11}>
                        </div>
                      </div>
                      {/*end::Chart*/}
                      {/*begin::Labels*/}
                      <div className="d-flex flex-column content-justify-center w-100">
                        ...
                        <div className="d-flex fs-6 fw-semibold align-items-center">
                          {/*begin::Bullet*/}
                          <div className="bullet w-8px h-6px rounded-2 me-3" style={{backgroundColor: '#E4E6EF'}} />
                          {/*end::Bullet*/}
                          {/*begin::Label*/}
                    ...
                    <div className="card-body d-flex align-items-end pt-0">
                      ...
                      <div className="d-flex align-items-center flex-column mt-3 w-100">
                        ...
                        <div className="h-8px mx-3 w-100 bg-light-success rounded">
                          <div className="bg-success rounded h-8px" role="progressbar" style={{width: '62%'}} aria-valuenow={50} aria-valuemin={0} aria-valuemax={100} />
                        </div>
                      </div>
                      {/*end::Progress*/}
                    </div>
                ...
                <div className="col-md-6 col-lg-6 col-xl-6 col-xxl-3 mb-md-5 mb-xl-10">
                  ...
                  <div className="card card-flush  h-md-50 mb-5 mb-xl-10">
                    ...
                    <div className="card-body d-flex align-items-end px-0 pb-0">       
                      {/*begin::Chart*/}
                      <div id="kt_card_widget_6_chart" className="w-100" style={{height: 80}} />
                      {/*end::Chart*/} 
                    </div>
                    {/*end::Card body*/}
                  </div>
                ...
                <div className="col-lg-12 col-xl-12 col-xxl-6 mb-5 mb-xl-0">
                  ...
                  <div className="card card-flush overflow-hidden h-md-100">
                    ...
                    <div className="card-body d-flex justify-content-between flex-column pb-1 px-0">  
                      ...
                      {/*end::Statistics*/}
                      {/*begin::Chart*/}
<div id="kt_charts_widget_3" className="min-h-auto ps-4 pe-6" style={{height: 300, minHeight: 315}}>
</div>
                            ...
                            <table className="table table-row-dashed align-middle gs-0 gy-4 my-0">
                              ...
                              <tbody>
                                <tr>
                                  ...
                                  <td className="ps-0">
                                    <a href="../apps/ecommerce/catalog/edit-product.html" className="text-gray-800 fw-bold text-hover-primary mb-1 fs-6 text-start pe-0">Elephant 1802</a>
                                ...
                                <tr>
                                  ...
                                  <td className="ps-0">
                                    <a href="../apps/ecommerce/catalog/edit-product.html" className="text-gray-800 fw-bold text-hover-primary mb-1 fs-6 text-start pe-0">Red Laga</a>
                                ...
                                <tr>
                                  ...
                                  <td className="ps-0">
                                    <a href="../apps/ecommerce/catalog/edit-product.html" className="text-gray-800 fw-bold text-hover-primary mb-1 fs-6 text-start pe-0">RiseUP</a>
                            ...
                            <table className="table table-row-dashed align-middle gs-0 gy-4 my-0">
                              ...
                              <tbody>
                                <tr>
                                  ...
                                  <td className="ps-0">
                                    <a href="../apps/ecommerce/catalog/edit-product.html" className="text-gray-800 fw-bold text-hover-primary mb-1 fs-6 text-start pe-0">Elephant 1324</a>
                            ...
                            <table className="table table-row-dashed align-middle gs-0 gy-4 my-0">
                              ...
                              <tbody>
                                <tr>
                                  ...
                                  <td className="ps-0">
                                    <a href="../apps/ecommerce/catalog/edit-product.html" className="text-gray-800 fw-bold text-hover-primary mb-1 fs-6 text-start pe-0">Elephant 2635</a>
                                    <span className="text-gray-400 fw-semibold fs-7 d-block text-start ps-0">Item: #XDG-1523</span>
                                  </td>
                                  <td>                                            
                                    <span className="text-gray-800 fw-bold d-block fs-6 ps-0 text-end">x1</span>
                            ...
                            <table className="table table-row-dashed align-middle gs-0 gy-4 my-0">
                              ...
                              <tbody>
                                <tr>
                                  ...
                                  <td className="ps-0">
                                    <a href="../apps/ecommerce/catalog/edit-product.html" className="text-gray-800 fw-bold text-hover-primary mb-1 fs-6 text-start pe-0">Nike</a>
                                ...
                                <tr>
                                  ...
                                  <td className="ps-0">
                                    <a href="../apps/ecommerce/catalog/edit-product.html" className="text-gray-800 fw-bold text-hover-primary mb-1 fs-6 text-start pe-0">Adidas</a>
                                ...
                                <tr>
                                  ...
                                  <td className="ps-0">
                                    <a href="../apps/ecommerce/catalog/edit-product.html" className="text-gray-800 fw-bold text-hover-primary mb-1 fs-6 text-start pe-0">Puma</a>
                ...
                <div className="col-xl-6 mb-5 mb-xl-10">
                  ...
                  <div className="card card-flush overflow-hidden h-md-100">
                    ...
                    <div className="card-body d-flex justify-content-between flex-column pb-1 px-0">  
                      ...
                      {/*end::Info*/}
                      {/*begin::Chart*/}
                      <div id="kt_charts_widget_4" className="min-h-auto ps-4 pe-6" style={{height: 300}} />
                      {/*end::Chart*/} 
                    </div>
                    {/*end::Card body*/}
                  </div>
                  ...
                  <div className="card h-md-100" dir="ltr"> 
                    ...
                    <div className="card-body d-flex flex-column flex-center">  
                      ...
                      <div className="text-center mb-1"> 
                        {/*begin::Link*/}
                        <a className="btn btn-sm btn-primary me-2" href="../apps/ecommerce/sales/listing.html">
                          View App          </a>
                        {/*end::Link*/}
                        {/*begin::Link*/}
                        <a className="btn btn-sm btn-light" href="../apps/ecommerce/catalog/add-product.html">
                          New Product          </a>
                        {/*end::Link*/}
                      </div>
                      {/*end::Links*/}
                      ...
                      <div className="card-toolbar">
                        ...
                        <div className="d-flex flex-stack flex-wrap gap-4">
                          ...
                          <div className="d-flex align-items-center fw-bold">
                            ...
                            {/*end::Label*/}
                            {/*begin::Select*/}
                            <select className="form-select form-select-transparent text-graY-800 fs-base lh-1 fw-bold py-0 ps-3 w-auto" data-control="select2" data-hide-search="true" data-dropdown-css-class="w-150px" data-placeholder="Select an option">
                              <option />
                          ...
                          <div className="d-flex align-items-center fw-bold">
                            ...
                            {/*end::Label*/}
                            {/*begin::Select*/}
                            <select className="form-select form-select-transparent text-dark fs-7 lh-1 fw-bold py-0 ps-3 w-auto" data-control="select2" data-hide-search="true" data-dropdown-css-class="w-150px" data-placeholder="Select an option" data-kt-table-widget-4="filter_status">
                              <option />
                              <option value="Show All" selected>Show All</option>
                          ...
                          <div className="position-relative my-1">
                            ...
                            <span className="svg-icon svg-icon-2 position-absolute top-50 translate-middle-y ms-4"><svg width={24} height={24} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <rect opacity="0.5" x="17.0365" y="15.1223" width="8.15546" height={2} rx={1} transform="rotate(45 17.0365 15.1223)" fill="currentColor" />
                                <path d="M11 19C6.55556 19 3 15.4444 3 11C3 6.55556 6.55556 3 11 3C15.4444 3 19 6.55556 19 11C19 15.4444 15.4444 19 11 19ZM11 5C7.53333 5 5 7.53333 5 11C5 14.4667 7.53333 17 11 17C14.4667 17 17 14.4667 17 11C17 7.53333 14.4667 5 11 5Z" fill="currentColor" />
                              </svg>
                            </span>
                            {/*end::Svg Icon*/}                    <input type="text" data-kt-table-widget-4="search" className="form-control w-150px fs-7 ps-12" placeholder="Search" />
                          </div>
                          {/*end::Search*/}
                        </div>
                        {/*begin::Filters*/}
                    ...
                    <div className="card-body pt-2">
                      ...
                      <table className="table align-middle table-row-dashed fs-6 gy-3" id="kt_table_widget_4_table">
                        ...
                        <tbody className="fw-bold text-gray-600">
                            ...
                            <td colSpan={2}>
                              <div className="d-flex align-items-center gap-3">
                                <a href="#" className="symbol symbol-50px bg-secondary bg-opacity-25 rounded">
                                  <img src="#" data-kt-src-path="/metronic8/demo27/assets/media/stock/ecommerce/" alt data-kt-table-widget-4="template_image" />
                                </a>
                          ...
                          <tr>
                            <td>
                              <a href="../apps/ecommerce/catalog/edit-product.html" className="text-gray-800 text-hover-primary">#XGY-346</a>
                            </td>
                            <td className="text-end">
                              7 min ago                           
                            </td>
                            ...
                            <td className="text-end">
                              <button type="button" className="btn btn-sm btn-icon btn-light btn-active-light-primary toggle h-25px w-25px" data-kt-table-widget-4="expand_row">
                                ...
                                <span className="svg-icon svg-icon-3 m-0 toggle-off"><svg width={24} height={24} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <rect opacity="0.5" x={11} y={18} width={12} height={2} rx={1} transform="rotate(-90 11 18)" fill="currentColor" />
                                    <rect x={6} y={11} width={12} height={2} rx={1} fill="currentColor" />
                                  </svg></span>
                                {/*end::Svg Icon*/}                                {/*begin::Svg Icon | path: icons/duotune/arrows/arr089.svg*/}
                                <span className="svg-icon svg-icon-3 m-0 toggle-on"><svg width={24} height={24} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <rect x={6} y={11} width={12} height={2} rx={1} fill="currentColor" />
                                  </svg>
                                </span>
                                {/*end::Svg Icon*/}                          </button>
                          ...
                          <tr>
                            <td>
                              <a href="../apps/ecommerce/catalog/edit-product.html" className="text-gray-800 text-hover-primary">#YHD-047</a>
                            </td>
                            <td className="text-end">
                              52 min ago                           
                            </td>
                          ...
                          <tr>
                            <td>
                              <a href="../apps/ecommerce/catalog/edit-product.html" className="text-gray-800 text-hover-primary">#SRR-678</a>
                            </td>
                            <td className="text-end">
                              1 hour ago                           
                            </td>
                          ...
                          <tr>
                            <td>
                              <a href="../apps/ecommerce/catalog/edit-product.html" className="text-gray-800 text-hover-primary">#PXF-534</a>
                            </td>
                            <td className="text-end">
                              3 hour ago                           
                            </td>
                          ...
                          <tr>
                            <td>
                              <a href="../apps/ecommerce/catalog/edit-product.html" className="text-gray-800 text-hover-primary">#XGD-249</a>
                            </td>
                            <td className="text-end">
                              2 day ago                           
                            </td>
                          ...
                          <tr>
                            <td>
                              <a href="../apps/ecommerce/catalog/edit-product.html" className="text-gray-800 text-hover-primary">#SKP-035</a>
                            </td>
                            <td className="text-end">
                              2 day ago                           
                            </td>
                          ...
                          <tr>
                            <td>
                              <a href="../apps/ecommerce/catalog/edit-product.html" className="text-gray-800 text-hover-primary">#SKP-567</a>
                            </td>
                            <td className="text-end">
                              7 min ago                           
                            </td>
                        ...
                        <div className="border border-dashed border-gray-300 rounded px-7 py-3 mb-6">                 
                          ...
                          <div className="d-flex flex-stack">
                            ...
                            <span className="text-gray-400 fw-bold">To: 
                              <a href="../apps/ecommerce/sales/details.html" className="text-gray-800 text-hover-primary fw-bold">
                                Jason Bourne                          </a>
                            </span>                   
                            {/*end::Name*/}
                            {/*begin::Label*/} 
...
export default ViewCreatedSite
