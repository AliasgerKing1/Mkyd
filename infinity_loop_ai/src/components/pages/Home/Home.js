    ...
    <div className="card-body pt-15 px-0">
        ...
        <div className="d-flex flex-column text-center mb-9 px-9">
            ...
            <div className="text-center">
                {/*begin::Name*/}
                <NavLink to="/auth/create/design" className="text-gray-800 fw-bold text-hover-primary fs-4">Aliasger Barood</NavLink>
                {/*end::Name*/}
        ...
        <div className="m-0">
            ...
            <ul className="nav nav-pills nav-pills-custom flex-column border-transparent fs-5 fw-bold">
                    ...
                    <li className="nav-item mt-5">
                        <a className="nav-link text-muted text-active-primary ms-0 py-0 me-10 ps-9 border-0 active" href="feeds.html">
...
{/*end::Svg Icon*/}                            
                    ...
                    {/*end::Nav item*/}
                                    {/*begin::Nav item*/}
                    <li className="nav-item mt-5">
                        <a className="nav-link text-muted text-active-primary ms-0 py-0 me-10 ps-9 border-0 " href="activity.html">
...
{/*end::Svg Icon*/}                            
                    ...
                    {/*end::Nav item*/}
                                    {/*begin::Nav item*/}
                    <li className="nav-item mt-5">
                        <a className="nav-link text-muted text-active-primary ms-0 py-0 me-10 ps-9 border-0 " href="followers.html">
...
{/*end::Svg Icon*/}                            
                    ...
                    {/*end::Nav item*/}
                                    {/*begin::Nav item*/}
                    <li className="nav-item mt-5">
                        <a className="nav-link text-muted text-active-primary ms-0 py-0 me-10 ps-9 border-0 " href="settings.html">
...
<div className="card card-flush mb-10">
    ...
    <div className="card-header justify-content-start align-items-center pt-4">
        ...
        <span className="text-gray-400 fw-semibold fs-6">What’s on your mind, Jerry?</span>
    </div>
    {/*end::Header*/}
