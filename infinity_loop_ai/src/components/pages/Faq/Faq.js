                        ...
                        >
                            ...
                            <div className="app-container  container-fluid d-flex flex-stack " id="kt_app_header_container">
                                ...
                                <div className="d-flex align-items-center d-block d-lg-none ms-n3" title="Show sidebar menu">
                                    ...
                                    {/*begin::Logo image*/}
                                    <a href="../../index.html">
                                        <img alt="Logo" src="/assetsmedia/logos/default-small.svg" className="h-30px theme-light-show" />
                                        <img alt="Logo" src="/assetsmedia/logos/default-small-dark.svg" className="h-30px theme-dark-show" />
                                    </a>
                                    {/*end::Logo image*/}
                                </div>
                                {/*end::Sidebar toggle*/}
                                                        ...
                                                        <div className="flex-column flex-lg-row-auto w-100 w-lg-275px mb-10 me-lg-20">
                                                            ...
                                                            <div className="mb-15">
                                                                ...
                                                                <div className="menu menu-rounded menu-column menu-title-gray-700 menu-state-title-primary menu-active-bg-light-primary fw-semibold">
                                                                    ...
                                                                    <div className="menu-item mb-1">
                                                                        {/*begin::Link*/}
                                                                        <a href="#" className="menu-link py-3 active">
                                                                            Bootstrap Admin                </a>
                                                                        {/*end::Link*/}
                                                                    </div>
                                                                    {/*end::Item*/}
                                                            ...
                                                            <div className="mb-16">
                                                                ...
                                                                <div className="position-relative">
                                                                    ...
                                                                    <span className="svg-icon svg-icon-3 svg-icon-gray-500 position-absolute top-50 translate-middle ms-6"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                            ...
                                                            <div className="m-0">
                                                                ...
                                                                <div className="d-flex flex-stack mb-7">
                                                                    ...
                                                                    <div className="symbol symbol-60px symbol-2by3 me-4">
                                                                        <div className="symbol-label" style={{ backgroundImage: "url('/assets/media/stock/600x400/img-1.jpg')" }}></div>
                                                                    </div>
                                                                    {/*end::Symbol*/}
                                                ...
                                                <div className="fv-row mb-10">
                                                    ...
                                                    {/* <style>
                                                        .image-input-placeholder {
                                                            background - image: url('/assetsmedia/svg/files/blank-image.svg');
                }

                                                        [data-bs-theme="dark"] .image-input-placeholder {
                                                            background - image: url('/assetsmedia/svg/files/blank-image-dark.svg');
                } */}
                                                    {/* </style> */}
                                                    ...
                                                    <div className="mh-300px scroll-y me-n7 pe-7">
                                                        ...
                                                        <div className="d-flex flex-stack py-4 border border-top-0 border-left-0 border-right-0 border-dashed">
                                                            <div className="d-flex align-items-center">
                                                                ...
                                                                <div className="symbol symbol-35px">
                                                                    <img src="/assetsmedia/svg/files/pdf.svg" alt="icon" />
                                                                </div>
                                                                {/*end::Avatar*/}
                                                        ...
                                                        <div className="d-flex flex-stack py-4 border border-top-0 border-left-0 border-right-0 border-dashed">
                                                            <div className="d-flex align-items-center">
                                                                {/*begin::Avatar*/}
                                                                <div className="symbol symbol-35px">
                                                                    <img src="/assetsmedia/svg/files/tif.svg" alt="icon" />
                                                                </div>
                                                                {/*end::Avatar*/}
                                                        ...
                                                        <div className="d-flex flex-stack py-4 border border-top-0 border-left-0 border-right-0 border-dashed">
                                                            <div className="d-flex align-items-center">
                                                                {/*begin::Avatar*/}
                                                                <div className="symbol symbol-35px">
                                                                    <img src="/assetsmedia/svg/files/folder-document.svg" alt="icon" />
                                                                </div>
                                                                {/*end::Avatar*/}
                                                        ...
                                                        <div className="d-flex flex-stack py-4 border border-top-0 border-left-0 border-right-0 border-dashed">
                                                            <div className="d-flex align-items-center">
                                                                {/*begin::Avatar*/}
                                                                <div className="symbol symbol-35px">
                                                                    <img src="/assetsmedia/svg/files/css.svg" alt="icon" />
                                                                </div>
                                                                {/*end::Avatar*/}
                                                        ...
                                                        <div className="d-flex flex-stack py-4 border border-top-0 border-left-0 border-right-0 border-dashed">
                                                            <div className="d-flex align-items-center">
                                                                {/*begin::Avatar*/}
                                                                <div className="symbol symbol-35px">
                                                                    <img src="/assetsmedia/svg/files/ai.svg" alt="icon" />
                                                                </div>
                                                                {/*end::Avatar*/}
                                                        ...
                                                        <div className="d-flex flex-stack py-4 ">
                                                            <div className="d-flex align-items-center">
                                                                {/*begin::Avatar*/}
                                                                <div className="symbol symbol-35px">
                                                                    <img src="/assetsmedia/svg/files/doc.svg" alt="icon" />
                                                                </div>
                                                                {/*end::Avatar*/}
                                        ...
                                        <div data-kt-stepper-element="content">
                                            ...
                                            <div className="w-100">
                                                ...
                                                <div className="text-center px-4">
                                                    <img src="/assetsmedia/illustrations/sketchy-1/9.png" alt="" className="mww-100 mh-350px" />
                                                </div>
                                                {/*end::Illustration*/}
                                            </div>
                                        </div>
                                    ...
                                    <div className="py-5">
                                            ...
                                            <div className="mh-375px scroll-y me-n7 pe-7">
                                                ...
                                                <a href="#" className="d-flex align-items-center p-3 rounded bg-state-light bg-state-opacity-50 mb-1">
                                                    ...
                                                    <div className="symbol symbol-35px symbol-circle me-5">
                                                        <img alt="Pic" src="/assetsmedia/avatars/300-6.jpg" />
                                                    </div>
                                                    {/*end::Avatar*/}
                                                ...
                                                <a href="#" className="d-flex align-items-center p-3 rounded bg-state-light bg-state-opacity-50 mb-1">
                                                    {/*begin::Avatar*/}
                                                    <div className="symbol symbol-35px symbol-circle me-5">
                                                        <img alt="Pic" src="/assetsmedia/avatars/300-1.jpg" />
                                                    </div>
                                                    {/*end::Avatar*/}
                                                ...
                                                <a href="#" className="d-flex align-items-center p-3 rounded bg-state-light bg-state-opacity-50 mb-1">
                                                    {/*begin::Avatar*/}
                                                    <div className="symbol symbol-35px symbol-circle me-5">
                                                        <img alt="Pic" src="/assetsmedia/avatars/300-5.jpg" />
                                                    </div>
                                                    {/*end::Avatar*/}
                                                ...
                                                <a href="#" className="d-flex align-items-center p-3 rounded bg-state-light bg-state-opacity-50 mb-1">
                                                    {/*begin::Avatar*/}
                                                    <div className="symbol symbol-35px symbol-circle me-5">
                                                        <img alt="Pic" src="/assetsmedia/avatars/300-25.jpg" />
                                                    </div>
                                                    {/*end::Avatar*/}
                                            ...
                                            <div className="mh-375px scroll-y me-n7 pe-7">
                                                ...
                                                <div className="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="6">
                                                    ...
                                                    <div className="d-flex align-items-center">
                                                        ...
                                                        {/*begin::Avatar*/}
                                                        <div className="symbol symbol-35px symbol-circle">
                                                            <img alt="Pic" src="/assetsmedia/avatars/300-9.jpg" />
                                                        </div>
                                                        {/*end::Avatar*/}
                                                ...
                                                <div className="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="9">
                                                    ...
                                                    <div className="d-flex align-items-center">
                                                        ...
                                                        {/*begin::Avatar*/}
                                                        <div className="symbol symbol-35px symbol-circle">
                                                            <img alt="Pic" src="/assetsmedia/avatars/300-23.jpg" />
                                                        </div>
                                                        {/*end::Avatar*/}
                                                ...
                                                <div className="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="11">
                                                    ...
                                                    <div className="d-flex align-items-center">
                                                        ...
                                                        {/*begin::Avatar*/}
                                                        <div className="symbol symbol-35px symbol-circle">
                                                            <img alt="Pic" src="/assetsmedia/avatars/300-12.jpg" />
                                                        </div>
                                                        {/*end::Avatar*/}
                                                ...
                                                <div className="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="13">
                                                    ...
                                                    <div className="d-flex align-items-center">
                                                        ...
                                                        {/*begin::Avatar*/}
                                                        <div className="symbol symbol-35px symbol-circle">
                                                            <img alt="Pic" src="/assetsmedia/avatars/300-13.jpg" />
                                                        </div>
                                                        {/*end::Avatar*/}
                                                ...
                                                <div className="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="15">
                                                    ...
                                                    <div className="d-flex align-items-center">
                                                        ...
                                                        {/*begin::Avatar*/}
                                                        <div className="symbol symbol-35px symbol-circle">
                                                            <img alt="Pic" src="/assetsmedia/avatars/300-21.jpg" />
                                                        </div>
                                                        {/*end::Avatar*/}
                                        ...
                                        <div data-kt-search-element="empty" className="text-center d-none">
                                            ...
                                            <div className="text-center px-5">
                                                <img src="/assetsmedia/illustrations/sketchy-1/1.png" alt="" className="w-100 h-200px h-sm-325px" />
                                            </div>
                                            {/*end::Illustration*/}
                                        </div>
                                        {/*end::Empty*/}                    </div>
