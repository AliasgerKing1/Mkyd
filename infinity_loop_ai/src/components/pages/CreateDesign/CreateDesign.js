...
const CreateDesign = () => {
    ...
    let [checkAccountStep1, setCheckAccountStep1] = useState("personal")
    ...
    <div className="fv-row">
        ...
        <div className="row">
            ...
            <div className="col-lg-6">
                {/*begin::Option*/}
                <input type="radio" className="btn-check" name="account_type" value="personal" checked={checkAccountStep1 == "personal" ? "checked" : ""} id="kt_create_account_form_account_type_personal" onFocus={(e)=>handleChangeStep1(e)} />
...
{/*end::Svg Icon*/}
            ...
            <div className="col-lg-6">
                {/*begin::Option*/}
                <input type="radio" className="btn-check" name="account_type" value="corporate" checked={checkAccountStep1 == "corporate" ? "checked" : ""} id="kt_create_account_form_account_type_corporate" onFocus={(e)=>handleChangeStep1(e)} />
