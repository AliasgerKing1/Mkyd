...
<span className="svg-icon svg-icon-3x me-5"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="row mb-2" data-kt-buttons="true"> 
            ...
            <div className="col">
                ...
                <label className={`btn btn-outline btn-outline-dashed btn-active-light-primary w-100 p-4 ${checkTeamSize == 1 ? "active" : ""}`} onClick={()=> {
                    ...
                    <input type="radio" className="btn-check" name="account_team_size" value="1-1"/>    
            ...
            <div className="col">
                ...
                <label className={`btn btn-outline btn-outline-dashed btn-active-light-primary w-100 p-4 ${checkTeamSize == 2 ? "active" : ""}`} onClick={()=> {
                    ...
                    <input type="radio" className="btn-check" name="account_team_size" checked value="2-10"/>  
            ...
            <div className="col">                            
                ...
                <label className={`btn btn-outline btn-outline-dashed btn-active-light-primary w-100 p-4 ${checkTeamSize == 3 ? "active" : ""}`} onClick={()=> {
                    ...
                    <input type="radio" className="btn-check" name="account_team_size" value="10-50"/>     
            ...
            <div className="col">                                      
                ...
                <label className={`btn btn-outline btn-outline-dashed btn-active-light-primary w-100 p-4 ${checkTeamSize == 4 ? "active" : ""}`} onClick={()=> {
                    ...
                    <input type="radio" className="btn-check" name="account_team_size" value="50+"/> 
...
<span className="svg-icon svg-icon-1 svg-icon-gray-600"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
{/*end::Svg Icon*/}                        </span>
                    ...
                    <span className="d-flex flex-column">
                        <span className="fw-bold text-gray-800 text-hover-primary fs-5">Company Account</span>
...
{/*end::Svg Icon*/}                        </span>
                    ...
                    {/*begin::Description*/}
                    <span className="d-flex flex-column">
                        <span className="fw-bold text-gray-800 text-hover-primary fs-5">Developer Account</span>
                ...
                {/*begin:Input*/}
                <span className="form-check form-check-custom form-check-solid">
                    <input className="form-check-input" type="radio" checked name="account_plan" value="2"/>
                </span>
                {/*end:Input*/}
            </label>
            {/*end::Option*/}
...
{/*end::Svg Icon*/}                        </span>
                    ...
                    {/*begin::Description*/}
                    <span className="d-flex flex-column">
                        <span className="fw-bold text-gray-800 text-hover-primary fs-5">Testing Account</span>
...
<div className="w-100">
    ...
    <div className="pb-8 pb-lg-10">
        ...
        <div className="text-muted fw-semibold fs-6">
            ...
            <a href="_br/__b_Deprecated_/b__%20%20strpos()_%20Passing%20null%20to%20parameter.html#1 ($haystack) of type string is deprecated in <b>/var/www/preview.keenthemes.com/kt-products/metronic/releases/2023-01-27-140618/core/html/dist/libs/Theme.php</b> on line <b>1007</b><br />
/metronic8/demo27/../demo27/.html" className="link-primary fw-bold">Sign In</a>.
        </div>
        {/*end::Notice*/}
    </div>
    {/*end::Heading*/}
...
{/*end::Svg Icon*/}                                </span>
                            ...
                            <button type="button" className="btn btn-lg btn-primary" data-kt-stepper-action="next" onClick={()=> {
                                setCheckStep(checkStep + 1)
                            }}>
                                Continue
                                {/*begin::Svg Icon | path: icons/duotune/arrows/arr064.svg*/}
