...
var KTFormsFlatpickrDemos = function() {
    ...
    var example1 = function(element) {
        $("#kt_datepicker_1").flatpickr({            
            //see gulp build config to set a localization: core/html/tools/gulp.config.js
            //"locale": "de"
        });
    ...
    var example3 = function(element) {
        $("#kt_datepicker_4").flatpickr({
            ...
            disable: ["2025-01-10", "2025-01-11", "2025-01-12", "2025-01-13", "2025-01-14", "2025-01-15", "2025-01-16", "2025-01-17"],
            dateFormat: "Y-m-d",
        });
