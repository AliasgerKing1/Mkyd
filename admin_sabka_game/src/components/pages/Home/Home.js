...
{/*end::Menu 2*/}
    ...
    <div className="card-body pt-0 pb-1">                 
        ...
        <div id="apexcharts21y48rj6" className="apexcharts-canvas apexcharts21y48rj6 apexcharts-theme-light" style={{width: '419px', height: '350px'}}>
        <svg
...
{/*end::Menu 2*/}
    ...
    <div className="card-body d-flex align-items-end ps-4 pe-0 pb-4">                 
        ...
        <div id="apexchartsi60j3klu" className="apexcharts-canvas apexchartsi60j3klu apexcharts-theme-light" style={{width: '464px', height: '300px'}}>
        <svg
      xmlns="http://www.w3.org/2000/svg"
      xmlnsData="ApexChartsNS"
      width="464"
...
{/*end::Menu 2*/}
    ...
    <div className="card-body d-flex align-items-end p-0">                 
        ...
        <div id="apexcharts0golmeqi" class="apexcharts-canvas apexcharts0golmeqi apexcharts-theme-light" style={{width: '454.25px', height: '300px'}}>
        <svg
      xmlns="http://www.w3.org/2000/svg"
      xmlnsData="ApexChartsNS"
      width="454.25"
